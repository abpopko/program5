...
class Customer {
            ...
            <body>
                ...
                <div class='container'>
                    <div class='span10 offset1'>
                        ...
                        <form class='form-horizontal' action='$this->tableName.html?fun=$funNext' method='post'>                        
                    ";
    ...
    private function generate_html_bottom ($fun) {
        ...
        echo " 
                            <div class='form-actions'>
                                $funButton
                                <a class='btn btn-secondary' href='$this->tableName.html'>Back</a>
                            </div>
                        </form>
                    </div>
                </div> <!-- /container -->
    ...
    function list_records() {
        ...
        echo "
            ...
            <body>
			<a href='https://github.com/abpopko/PopkoProgram2'>Github</a>
                <div class='container'>
                    <p class='row'>
                        <h3>$this->title" . "s" . "</h3>
                    </p>
                    <p>
                        <a href='$this->tableName.html?fun=1' class='btn btn-success'>Create</a>
                    </p>
                    <div class='row'>
        ...
        foreach ($pdo->query($sql) as $row) {
            ...
            echo "<td width=250>";
            echo "<a class='btn btn-info' href='$this->tableName.html?fun=2&id=".$row["id"]."'>Read</a>";
            echo "&nbsp;";
            echo "<a class='btn btn-warning' href='$this->tableName.html?fun=3&id=".$row["id"]."'>Update</a>";
            echo "&nbsp;";
            echo "<a class='btn btn-danger' href='$this->tableName.html?fun=4&id=".$row["id"]."'>Delete</a>";
            echo "</td>";
            echo "</tr>";
        }
        Database::disconnect();        
